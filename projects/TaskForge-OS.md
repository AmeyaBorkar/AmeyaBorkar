...
> A course-project operating system kernel in C (with a Python/Flask port) that runs a banking application through its own system calls — process management, memory allocation, deadlock prevention, I/O scheduling, all demonstrated live with a four-tab dashboard.

**Repository:** [`AmeyaBorkar/TaskForge-OS`](https://github.com/AmeyaBorkar/TaskForge-OS)  
...
**Metadata updated:** 2026-04-28  
**Size (GitHub reported):** 956 KB  
...
- Total entries indexed: **38** (31 files, 7 directories)

```
.gitignore  (42 B)
CONTRIBUTIONS.md  (11 KB)
Makefile  (2 KB)
README.md  (8 KB)
TaskForge_OS_Project_Report.docx  (903 KB)
build.bat  (4 KB)
generate_report.py  (29 KB)
main.c  (6 KB)
main_v2.c  (16 KB)
app/    [2 files]
  app/bank.c
