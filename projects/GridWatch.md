...
> A C11 emergency-dispatch simulator (libdispatch + TUI + Python/Flask web UI) that exercises the entire Advanced Data Structures syllabus — Fibonacci heaps, Huffman coding, suffix arrays, BK-trees, DSU, tries — by routing ambulances around a grid city in real time.

**Repository:** [`AmeyaBorkar/GridWatch`](https://github.com/AmeyaBorkar/GridWatch)  
**Category:** Systems / Data Structures (educational)  
**Visibility:** Public  
**Primary language:** C  
**Default branch:** `main`  
**License:** —  
...
- Total entries indexed: **92** (75 files, 17 directories)

```
.gitignore  (109 B)
CONTRIBUTIONS.md  (9 KB)
Makefile  (2 KB)
README.md  (8 KB)
build.sh  (2 KB)
docs/    [1 files]
...
src/    [44 files]
  src/ds/heaps/binom.c
  src/ds/heaps/depq.c
  src/ds/heaps/fib.c
  src/ds/heaps/leftist.c
  src/ds/heaps/pairing.c
  src/ds/heaps/skew.c
  src/ds/misc/bv.c
  src/ds/misc/dsu.c
  src/ds/misc/plist.c
  src/ds/randomized/rng.c
  src/ds/randomized/skip.c
  src/ds/randomized/treap.c
  src/ds/spatial/bsp.c
  src/ds/spatial/itree.c
  src/ds/spatial/kd.c
  ... and 29 more under src/
tests/    [7 files]
  tests/test_heaps.c
  tests/test_misc.c
  tests/test_randomized.c
  tests/test_sim.c
