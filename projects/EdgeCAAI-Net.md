...
> Lightweight (~1.42M parameter) music-genre classifier for edge devices. Uses adversarial Gradient Reversal to combat artist-leakage bias; documents an 18.8% relative F1 gap between track-disjoint and artist-disjoint splits.

**Repository:** [`AmeyaBorkar/EdgeCAAI-Net`](https://github.com/AmeyaBorkar/EdgeCAAI-Net)  
**Category:** ML Research / Audio  
**Visibility:** Public  
...
**Metadata updated:** 2026-05-01  
**Size (GitHub reported):** 252 KB  
...
- Total entries indexed: **103** (65 files, 38 directories)

```
.gitattributes  (41 B)
.gitignore  (305 B)
EdgeCAAI-Net_Project_Documentation.docx  (27 KB)
README.md  (11 KB)
eval.py  (8 KB)
requirements.txt  (215 B)
run_all.py  (6 KB)
train.py  (15 KB)
train_baseline.py  (9 KB)
configs/    [16 files]
  configs/ablations/backbone_only.yaml
  configs/ablations/exits_budget.yaml
  configs/ablations/exits_only.yaml
  configs/ablations/full_groupdro.yaml
  configs/baselines/mobilenet_artist.yaml
  configs/baselines/mobilenet_track.yaml
  configs/baselines/small_crnn_artist.yaml
  configs/baselines/small_crnn_track.yaml
  configs/baselines/tiny_cnn_artist.yaml
  configs/baselines/tiny_cnn_track.yaml
  configs/baselines/tiny_transformer_artist.yaml
  configs/baselines/tiny_transformer_track.yaml
  configs/default.yaml
  configs/fma_artist_disjoint.yaml
  configs/fma_track_disjoint.yaml
  ... and 1 more under configs/
data/    [13 files]
  data/processed/.gitkeep
  data/splits/.gitkeep
  data/splits/artist_disjoint_test.json
  data/splits/artist_disjoint_train.json
  data/splits/artist_disjoint_val.json
  data/splits/fma_genre_map.json
  data/splits/gtzan_genre_map.json
  data/splits/gtzan_track_disjoint_test.json
  data/splits/gtzan_track_disjoint_train.json
  data/splits/gtzan_track_disjoint_val.json
  data/splits/track_disjoint_test.json
  data/splits/track_disjoint_train.json
  data/splits/track_disjoint_val.json
models/    [9 files]
  models/__init__.py
  models/artist_invariance.py
  models/baselines/__init__.py
  models/baselines/mobilenet_baseline.py
  models/baselines/small_crnn.py
  models/baselines/tiny_cnn.py
  models/baselines/tiny_transformer.py
  models/edgecaai_net.py
  models/exits.py
results/    [15 files]
  results/ablations/backbone_only/checkpoints/best.pt
  results/ablations/exits_budget/checkpoints/best.pt
  results/ablations/exits_only/checkpoints/best.pt
  results/baselines/mobilenet_artist/checkpoints/best.pt
  results/baselines/mobilenet_track/checkpoints/best.pt
  results/baselines/small_crnn_artist/checkpoints/best.pt
  results/baselines/small_crnn_track/checkpoints/best.pt
  results/baselines/tiny_cnn_artist/checkpoints/best.pt
  results/baselines/tiny_cnn_track/checkpoints/best.pt
  results/fma_artist_disjoint/checkpoints/best.pt
  results/fma_track_disjoint/checkpoints/best.pt
  results/gtzan/checkpoints/best.pt
