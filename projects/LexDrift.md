...
> Financial-intelligence platform that detects *semantic shifts* in SEC filings (10-K, 10-Q, 8-K) as leading indicators of corporate distress or strategic change. FastAPI + Next.js.

**Repository:** [`AmeyaBorkar/lexdrift`](https://github.com/AmeyaBorkar/lexdrift)  
**Category:** ML Application / FinNLP  
**Visibility:** Public  
...
|----------|------:|------:|
| Python | 595,887 | 86.8% |
| TypeScript | 85,333 | 12.4% |
| CSS | 2,507 | 0.4% |
| Dockerfile | 1,336 | 0.2% |
| Mako | 635 | 0.1% |
| JavaScript | 559 | 0.1% |

## File tree

- Total entries indexed: **146** (117 files, 29 directories)
...
README.md  (12 KB)
alembic.ini  (577 B)
docker-compose.yml  (982 B)
pyproject.toml  (1 KB)
alembic/    [4 files]
  alembic/env.py
  alembic/script.py.mako
  alembic/versions/c6f303a1b05c_initial_schema.py
  alembic/versions/e013c837d927_add_sentence_changes_table.py
frontend/    [33 files]
  frontend/.gitignore
  frontend/AGENTS.md
  frontend/CLAUDE.md
  ...
  ... and 18 more under frontend/
models/    [1 files]
  models/risk_classifier.pt
scripts/    [2 files]
  scripts/backfill.py
  scripts/run_all.py
src/    [52 files]
  src/lexdrift/__init__.py
  src/lexdrift/api/__init__.py
  src/lexdrift/api/alerts.py
  src/lexdrift/api/companies.py
  src/lexdrift/api/drift.py
  src/lexdrift/api/filings.py
  src/lexdrift/api/research.py
  src/lexdrift/config.py
  src/lexdrift/db/__init__.py
  src/lexdrift/db/engine.py
  src/lexdrift/db/models.py
  src/lexdrift/db/session.py
  src/lexdrift/edgar/__init__.py
  src/lexdrift/edgar/client.py
  src/lexdrift/edgar/filings.py
  ... and 37 more under src/
tests/    [18 files]
  tests/__init__.py
  tests/conftest.py
  ...
  tests/test_edgar/__init__.py
  tests/test_edgar/test_parser.py
  tests/test_integration.py
  tests/test_nlp/__init__.py
  tests/test_nlp/test_anomaly.py
  tests/test_nlp/test_diff.py
  tests/test_nlp/test_entropy.py
  tests/test_nlp/test_obfuscation.py
  tests/test_nlp/test_phrases.py
  tests/test_nlp/test_risk.py
  ... and 3 more under tests/
```
...
*Generated 2026-05-16 from GitHub API. Source of truth: https://github.com/AmeyaBorkar/lexdrift*
